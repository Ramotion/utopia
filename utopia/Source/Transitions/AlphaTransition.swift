...
public enum CustomTransitionAnimation {}
...
extension CustomTransitionAnimation {
  ...
  public static func alphaDismiss(using transitionContext: UIViewControllerContextTransitioning, duration: TimeInterval, isNavigation: Bool = false, completion: @escaping () -> Void = {}) {
