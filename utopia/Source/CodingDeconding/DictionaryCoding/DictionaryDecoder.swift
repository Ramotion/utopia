    ...
    fileprivate func unbox(_ value: Any, as type: Bool.Type) throws -> Bool? {
        ...
        if let number = value as? NSNumber {
            ...
            if number === kCFBooleanTrue as NSNumber {
                ...
                return number != 0 // TOD: Add a flag to disallow non-boolean numbers?
            }
            
            /* FIXM: If swift-corelibs-foundation doesn't change to use NSNumber, this code path will need to be included and tested:
