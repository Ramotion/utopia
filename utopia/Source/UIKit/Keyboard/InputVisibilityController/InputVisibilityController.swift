...
public class InputVisibilityController: NSObject {
...
public extension UIView {
    ...
    public func addInputVisibilityController() -> InputVisibilityController {
        ...
        if keyboardController == nil {
            keyboardController = InputVisibilityController(viewToMove: self)
            keyboardController?.dismissKeyboardTouchRecognizer = TouchRecognizer(target: keyboardController, action: #selector(InputVisibilityController.dismissFirstResponder))
