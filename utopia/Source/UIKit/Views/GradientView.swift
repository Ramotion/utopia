...
@IBDesignable open class GradientView: UIView {
  ...
  /// 1px borders will be drawn instead of 1pt borders. The default is `false`.
  @IBInspectable open var drawsThinBorders: Bool = false {
    didSet {
      setNeedsDisplay()
    }
  }
  ...
  override open func draw(_ rect: CGRect) {
    ...
    let borderWidth: CGFloat = drawsThinBorders ? 1.0 / screen.scale : 0.0
